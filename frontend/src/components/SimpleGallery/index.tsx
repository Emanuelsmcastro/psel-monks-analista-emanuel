        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
            ...
            {simpleGallery[0] && (
              <div className="flex items-start">
                <img
                  ...
                  alt={
                    simpleGallery[0]._embedded["wp:featuredmedia"]?.[0].alt_text
                  }
          ...
          <div className="flex flex-col gap-6 h-full">
            {simpleGallery[1] && (
              <img
                src={
                  simpleGallery[1]._embedded["wp:featuredmedia"]?.[0].source_url
                }
                alt={
            ...
            {simpleGallery[2] && (
              <img
                src={
                  simpleGallery[2]._embedded["wp:featuredmedia"]?.[0].source_url
                }
                alt={
